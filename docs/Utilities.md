...
| `compare`   | [`VbCompareMethod`][vba_cmp_mtd] |          | `vbUseCompareOption`     | Should detection be case-sensitive (`vbBinaryCompare`) or insensitive (`vbTextCompare`)?  Defaults to the current setting for [`Option Compare`][vba_opt_cmp]. |
