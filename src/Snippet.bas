...
Private Function New_Obj(ByVal class As String) As Collection
...
Private Sub Obj_Check(ParamArray fields() As Variant)
End Sub
...
Private Function Obj_FormatFields0(ParamArray fields() As Variant) As String
	Dim f() As Variant: f = fields
